<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="filevault_auth_restart_support-widget">
        <div id="filevault_auth_restart_support-widget" class="panel-heading" data-container="body" data-i18n="[title]filevault_status.auth_restart_support">
            <h3 class="panel-title"><i class="fa fa-arrow-circle-right"></i> 
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/filevault_status/get_auth_restart_support', function( data ) {
        ...
        var panel = $('#filevault_auth_restart_support-widget div.panel-body'),
